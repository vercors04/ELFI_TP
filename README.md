...
**La documentation de chaque fonction** se trouve dans le header associé à cette 
dernière (chaque dossier contient un header declarant les fonctions qui s'y
trouvent).
